    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAwareScrollView>
        ...
        <View style={styles.content}>
          ...
          />
          <Text style={styles.content_date_label}>
            Date of Birthday
          </Text>
          <TouchableOpacity
            ...
            {dob.length == 0 ? (
              <Text
                style={styles.content_date_unselect}>
                DD-MM-YYYY
              </Text>
            ) : (
              <View
                style={styles.content_date_select}>
          ...
          <Text
            style={styles.content_gender}>
            Gender
          </Text>
          <View
            style={styles.content_gender_chechbox}>
            <Checkbox
              label="Male"
...
const styles = StyleSheet.create({
  ...
  header_image:{
    height: 150, width: 150, borderRadius: 200
  },
  header_text:{
    color: '#1abc9c', marginTop: 5
  },
  content:{
    flex: 3.5, marginHorizontal: 20, marginVertical: 20
  },
  content_date_label:{
    fontSize: 16, 
    color: '#4d4d4d'
